 ...
 */
exports.url = o => Object.keys(o).map(p => Array.isArray(o[p]) ? o[p].map((r, q) => exports.url({ [p + `[${q}]`]: r })).join("&") : (typeof o[p] === "object" && o[p] !== null) ? exports.url(Object.keys(o[p]).reduce((r, q) => Object.assign(r, { [p + `[${q}]`]: o[p][q] }), {})) : p + "=" + encodeURIComponent(o[p])).join("&");
