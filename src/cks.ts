 ...
 */
export const cks=()=>(C=>C===""?{}:decodeURIComponent(C).split("; ").map(c=>c.split(/=(.+)?/)).map(c=>({[c[0]]:(s=>{try{return JSON.parse(s)}catch(e){return !1}})(c[1])||c[1]})).reduce((o,c)=>Object.assign(o,c)))(document.cookie);
