 ...
 */
export const url=(o:{[property:string]:any|any[]}):string=>Object.keys(o).map(p=>(i=>Array.isArray(i)?i.map((r,q)=>url({[p+`[${q}]`]:r})).join("&"):typeof i==="object"&&i!==null?url(Object.keys(i).reduce((r,q)=>Object.assign(r,{[p+`[${q}]`]:i[q]}),{})):p+"="+encodeURIComponent(i))(o[p])).join("&");
